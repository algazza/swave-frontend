      ...
      <div class="space-y-4 p-4 border-2 border-secondary rounded-xl">
        ...
        <div v-for="product in data.products" class="space-y-2">
          <div class="flex gap-5 w-full">
            <div class="size-20 aspect-square"><NuxtImg :src="product.image_path" :alt="product.name" class="object-center object-cover w-full h-full overflow-hidden"/></div>
...
</NuxtLink :to="`/account/transaction/${data.id}`">
</template>
